...
//                                .requestMatchers("/api/v1/auth/**").permitAll()
                                ...
                                .requestMatchers("/api/v1/Saveur/all", "/get/{id}", "/edit/{id}").hasAnyAuthority("ADMIN", "USER")
                                .requestMatchers("/api/v1/garniture/all", "/get/{id}", "/edit/{id}").hasAnyAuthority("ADMIN", "USER")
                                .anyRequest()
                                .authenticated()
                )
